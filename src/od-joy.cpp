...
void read_joystick(int nr, unsigned int *dir, int *button)
{
    ...
    *button = 0;
    ...
    nr = (~nr)&0x1;
printf("read_joystick pre\n");
    SDL_JoystickUpdate ();
printf("read_joystick post\n");
    ...
    *button = SDL_JoystickGetButton(joy,2) & 1;
	...
	else
	{
		...
		if (!gp2xMouseEmuOn && ((SDL_JoystickGetButton(joy, GP2X_BUTTON_Y)| SDL_JoystickGetButton(joy, GP2X_BUTTON_CLICK))& !delay1 & mainMenu_autofire))
		{
