...
#ifdef PANDORA
	#ifdef SOFTSTRETCH
		prSDLScreen=SDL_SetVideoMode(768,480,16,VIDEO_FLAGS);
		prSDLScaleScreen = SDL_SetVideoMode(768, 480, 16, VIDEO_FLAGS);
	#else
...
void gui_handle_events (void)
{
	...
	if(SDL_JoystickGetButton(uae4all_joy0, GP2X_BUTTON_L) && keystate[SDLK_1])
		screenmode = 0;
	if(SDL_JoystickGetButton(uae4all_joy0, GP2X_BUTTON_L) && keystate[SDLK_2])
		screenmode = 1;
	if(SDL_JoystickGetButton(uae4all_joy0, GP2X_BUTTON_L) && keystate[SDLK_3])
		screenmode = 2;
	if(SDL_JoystickGetButton(uae4all_joy0, GP2X_BUTTON_L) && keystate[SDLK_4])
		screenmode = 3;
#endif
#endif
}
