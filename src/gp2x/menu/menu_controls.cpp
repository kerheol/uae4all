...
char *text_str_controls_separator="----------------------------------";
char *text_str_controls_title=    "         Custom Controls         -";
char mapping[20]="";
int menuControls = 0;
...
/*extern int mainMenu_custom_RA;
extern int mainMenu_custom_RB;
extern int mainMenu_custom_RX;
extern int mainMenu_custom_RY;
extern int mainMenu_custom_LA;
extern int mainMenu_custom_LB;
extern int mainMenu_custom_LX;
extern int mainMenu_custom_LY;*/
